...
class UnhideAllOperator(bpy.types.Operator):
    bl_idname = "object.unhide_all"
    bl_label = "Unhide All Objects and Collections"
...
def register():
    ...
    bpy.utils.register_class(UnhideAllOperator)
...
def unregister():
    ...
    bpy.utils.unregister_class(UnhideAllOperator)
